 ...
 * @Last Modified time: 2019-04-01 17:49:55
 */
...
module.exports = async (params) => {
	...
	await page.goto('https://www.csdn.net/nav/iot');
	await page.waitForSelector('#feedlist_id li[data-type="blog"] div.list_con .title>h2>a');
	let data = await page.$$eval('#feedlist_id li[data-type="blog"] div.list_con .title>h2>a', (links) =>
		links.map((el) => {
			return {
				href: el.href.trim(),
